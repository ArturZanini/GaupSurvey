		...
		handlers: {
			...
			polygon: {
				tooltip: {
					...
					end: 'Clique no primeiro ponto para finalizar o desenho.'
				}
			},
			polyline: {
				...
				tooltip: {
					...
					cont: 'Clique para continuar a linha de desenho.',
	...
	edit: {
		toolbar: {
			actions: {
				...
				cancel: {
					title: 'Cancele a edição e descarte todas as alterações.',
					text: 'Cancelar'
				}
			},
			buttons: {
		...
		handlers: {
			edit: {
				tooltip: {
					text: 'Arraste o ponto ou marcador para editar o desenho.',
